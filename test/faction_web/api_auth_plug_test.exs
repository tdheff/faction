defmodule FactionWeb.APIAuthPlugTest do
  use FactionWeb.ConnCase
  doctest FactionWeb.APIAuthPlug

  alias FactionWeb.{APIAuthPlug, Endpoint}
  alias Faction.{Repo, Users.User}
  alias Plug.Conn
  ...
  setup %{conn: conn} do
    ...
    user = Repo.insert!(%User{id: 1, email: "test@example.com", name: "some name"})
